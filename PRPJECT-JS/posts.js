    ...
    let adres = 'http://46.100.94.88:3000/get/posts';
    ...
    if (result.status === 200) {
        ...
        data.posts.forEach(d => {
            r += `<div class="post_list"><div class="post_box"> <h3>User ID :${d.user_id}</h3> <div class="image_container"><img src="${url}${d.image}"/></div> <p>${d.description}</p></div></div>`;
        });
    }
    else {
        alert("erorr");
